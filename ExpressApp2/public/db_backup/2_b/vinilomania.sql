...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 31 2018 г., 22:03
...
SELECT COUNT(*) INTO countGoods FROM orders WHERE ID_order_status=1 AND User_ID=user_id;
...
(13, 1, 1, 1, '2018-05-31 19:35:13', 13, 1),
(14, 1, 1, 1, '2018-05-31 19:35:18', 6, 2),
(15, 1, 2, 1, '2018-05-31 19:35:25', 3, 1),
...
('tDDjMBk98YI7zN9zNxOR3bPKJ8zwzdo8', 1527872108, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{},\"passport\":{\"user\":{\"username\":\"u1@email\",\"userID\":1,\"userRoleID\":2}}}');
